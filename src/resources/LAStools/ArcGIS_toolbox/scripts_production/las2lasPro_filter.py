...
gp.AddMessage("Starting las2las (filter) production ...")
...
if sys.argv[c] != "#":
    command.append("-" + sys.argv[c])
    if sys.argv[c + 1] != "#":
        if sys.argv[c] == "keep_classification" or sys.argv[c] == "drop_classification" or sys.argv[
            c] == "keep_return" or sys.argv[c] == "drop_return":
