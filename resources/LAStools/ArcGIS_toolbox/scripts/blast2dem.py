...
#
# uses blast2dem.exe to raster a LiDAR file
#
...
gp.AddMessage("Starting blast2dem ...")
...
if os.path.exists(lastools_path) == False:
    gp.AddMessage("Cannot find blast2dem.exe at " + blast2dem_path)
    sys.exit(1)
else:
...
### check return code
if returncode != 0:
    gp.AddMessage("Error. blast2dem failed.")
    sys.exit(1)

### report happy end
gp.AddMessage("Success. blast2dem done.")
