...
#
# uses lasground.exe to extract bare-earth points for
# folders of LiDAR files. classifies points into ground
# (class 2) and non-ground points (class 1).
#
...
gp.AddMessage("Starting lasground production ...")
